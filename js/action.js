$(document).on("submit", "form", function (e) {
    ...
    $.ajax({
      ...
      success: function (xhr) {
        if(xhr == "Dosya daha önceden yüklenmiş" || xhr == "Dosya boyutu sınırı" || xhr == "Sadece jpg, jpeg, ico ve png uzantılı dosyalar yüklenebilir." || xhr == "Hata oluştu" || xhr == "Lütfen bir dosya seçin"){
            alert(xhr);
        }else{
